...
class MyDataset(Dataset):
    def __init__(self, path, split, resolution, pairs):
        ...
        if (self.split == "train"):
            ...
            # print('exist text?', os.path.exists("text.txt"))
    ...
    def __getitem__(self, index):
        ...
        if (pair_id == 0):
            # print('111', len(self.sequence_imgs), len(self.sequence_imgs[self.sequence[sequence_index]]))
        ...
        # print('222', len(self.sequence_imgs), len(self.sequence_imgs[self.sequence[sequence_index]]))
        # print('fuckoff', self.sequence_imgs[self.sequence[sequence_index]])
